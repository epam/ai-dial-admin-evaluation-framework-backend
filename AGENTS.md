...
- All Spring component classes MUST have `@LogExecution` annotation at the class level (`@RestController`, `@Controller`, `@Service`, `@Repository`, `@Component`, `@Configuration`). Import: `com.epam.aidial.evaluation.runner.config.logging.LogExecution`
