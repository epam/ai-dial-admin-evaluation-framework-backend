...
| [Anthropic Messages API support](docs/patterns/anthropic-messages-api.md) | Deployment-less `/anthropic/v1/messages` URL passthrough; third `StreamingResponseAccumulator` mode; `model`-in-body |
