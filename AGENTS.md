...
| [Inline metric evaluation](docs/patterns/inline-metric-evaluation.md) | Derived (not configured) mode; `$_metrics` frame; total seam in `TurnLoopExecutor`; `Expression` binding source |
