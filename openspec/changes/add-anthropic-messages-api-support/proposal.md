...
- Docs: `openspec/specs/eval-execution-engine/spec.md` (delta), `openspec/specs/test-suites/spec.md` (delta), new `docs/patterns/anthropic-messages-api.md`, `AGENTS.md` Unique Patterns table row.
