...
- **WHEN** any successful export is invoked
- **THEN** the header SHALL contain `testCaseName`, `responseStatusCode`, and `extractionWarnings` exactly as written (no `:` in their names)
