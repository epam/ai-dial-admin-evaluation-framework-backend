...
- [x] 10.3 Manual smoke via Swagger UI: upload to dataset → list → download → delete → confirm DIAL folder path. (Pending — needs a running DIAL Core instance; deferred to reviewer.)
