...
`SseEventParser`, `SseEvent`, `SseParseResult`, `StreamingResponseAccumulator`, `CustomContentAccumulator` (DIAL `custom_content` chunk merge), `ResponsesApiAccumulator` (OpenAI Responses stream assembly)
