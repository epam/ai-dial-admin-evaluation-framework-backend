 ...
 *
 * <p>Both components are non-null: the query INNER JOINs the two tables, so a declaration without any
 * version row is absent from the result rather than present with a null version.
 */
