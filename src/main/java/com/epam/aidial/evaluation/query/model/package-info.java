/**
 * Record-based object model for the structured query DSL (request side).
 *
 * <p>Mirrors the §1–§7 wire grammar of {@code docs/query-dsl/structured-query-model-v8.html}: a
 ...
 *
 * <p>{@link com.epam.aidial.evaluation.query.model.Expr} (by {@code type}) and {@link
 * com.epam.aidial.evaluation.query.model.PageSpec} (by {@code type}) use declarative
 * Jackson NAME discriminators. {@link
 * com.epam.aidial.evaluation.query.model.FilterNode} is routed by {@link
 * com.epam.aidial.evaluation.query.model.FilterNodeDeserializer} because its {@code op}
