...
import com.epam.aidial.evaluation.query.service.translate.FilterTranslator;
 ...
 * suite's {@code testCaseFilter} (a Structured Query DSL filter subtree). Translates the stored
 * filter into a jOOQ {@link Condition} via the Structured Query DSL translation layer
...
public class QueryDslRunnableTestCaseSelector {
