...
import static com.epam.aidial.evaluation.query.service.TestSuiteRunQueryFields.RUN_CONFIG_COLUMN;
 ...
 * fields), plus a {@code run_config}-backed {@code number_of_runs} scalar field, the
 * {@code suite_snapshot}-backed {@code suite_type}/{@code deployment_ref::*}/
...
public class TestSuiteRunsSchemaProvider implements QueryableEntitySchemaProvider {
    ...
    public TestSuiteRunsSchemaProvider(JooqTableSchemaResolver schemaResolver) {
        ...
        schema.add(new QuerySchemaFieldDto(NUMBER_OF_RUNS_FIELD, QueryFieldType.INTEGER, RUN_CONFIG_COLUMN));
