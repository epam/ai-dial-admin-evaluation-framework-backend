...
import com.epam.aidial.evaluation.query.service.QueryEntityRegistry;
...
/**
 * Schema discovery for the structured query DSL. Publishes which entities can be queried and which
 * flat field names are valid in a structured query's {@code filter}/{@code select}/{@code sort}
 * sections.
 */
@Slf4j
@RestController
