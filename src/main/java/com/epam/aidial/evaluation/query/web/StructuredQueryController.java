package com.epam.aidial.evaluation.query.web;

import com.epam.aidial.evaluation.query.model.StructuredQuery;
import com.epam.aidial.evaluation.query.service.StructuredQueryService;
import com.epam.aidial.evaluation.query.service.dto.StructuredQueryResultDto;
...
/**
 * Executes structured queries for the DSL. A single entity-agnostic endpoint: the {@code entity} in
 * the request body selects which backing table/datasource runs the query, so the same contract
 * serves {@code test_suites} (meta) and {@code eval_summaries} (analytics). Discover valid entities
 * and field names via the schema endpoints on {@link QuerySchemaController}.
 */
@Slf4j
@RestController
@LogExecution
...
@Tag(name = "Structured Queries", description = "Entity and flat-schema discovery for the structured query DSL.")
